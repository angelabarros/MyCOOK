...
namespace mycook.Controllers
{
    public class ingredients_recipeController : ApiController
    {
        ...
        // DELETE: api/ingredients_recipe/5
        [ResponseType(typeof(ingredients_recipe))]
